...
<div id="home-select" class="clearfix">
    ...
    <div class="home-select-boxes clearfix">
        <div class="home-box">
            <a class="home-box-click" href="<?php echo get_post_meta( get_the_ID(), 'pressable_plan_agency_link', true ); ?>" title="Agencies/Developers">
        ...
        <div class="home-box">
            <a class="home-box-click" href="<?php echo get_post_meta( get_the_ID(), 'pressable_plan_marketer_link', true ); ?>" title="Marketers">
        ...
        <div class="home-box last-item">
            <a class="home-box-click" href="<?php echo get_post_meta( get_the_ID(), 'pressable_plan_enterprise_link', true ); ?>" title="Enterprise">
